...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, RED_D18_Pin|BLUE_D19_Pin|BLUE_D20_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PF9 PF10 PF2 PF6 */
  ...
  GPIO_InitStruct.Pin = RED_D18_Pin|BLUE_D19_Pin|BLUE_D20_Pin;
